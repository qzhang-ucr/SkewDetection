...
public class ComputationSkewTools extends DataSkewTools{
    ...
    private static int findStartTime(String textLine)
    {
        ...
        if (!master.find())
        {
            System.out.println("Error: No Launch Time find:");
            return 0;
        }
    ...
    private static int findEndTime(String textLine)
    {
        ...
        if (!master.find())
        {
            System.out.println("Error: No Finish Time find:");
            return 0;
        }
        return master.end()+5; //To ensure time is less than Max_Value of int
    }

    static int timeCalculate(String textLine)
    {
    ...
    private static int findRecord(String textLine)
    {
        ...
        if (!master.find())
        {
            System.out.println("Error: No Records find:");
            return 0;
        }
    ...
    static int recordCalculate(String textLine)
    {
